...
package org.ucb.collect.android.activities;
...
import org.ucb.collect.android.application.Collect;
import org.ucb.collect.android.listeners.AdvanceToNextListener;
import org.ucb.collect.android.listeners.FormLoaderListener;
import org.ucb.collect.android.listeners.FormSavedListener;
import org.ucb.collect.android.logic.FormController;
import org.ucb.collect.android.logic.PropertyManager;
import org.ucb.collect.android.logic.FormController.FailedConstraint;
import org.ucb.collect.android.preferences.AdminPreferencesActivity;
import org.ucb.collect.android.preferences.PreferencesActivity;
import org.ucb.collect.android.provider.InstanceProviderAPI;
import org.ucb.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.ucb.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.ucb.collect.android.tasks.FormLoaderTask;
import org.ucb.collect.android.tasks.SaveToDiskTask;
import org.ucb.collect.android.utilities.FileUtils;
import org.ucb.collect.android.utilities.MediaUtils;
import org.ucb.collect.android.views.ODKView;
import org.ucb.collect.android.widgets.QuestionWidget;
...
public class FormEntryActivity extends Activity implements AnimationListener,
	...
	private void sendSavedBroadcast() {
		Intent i = new Intent();
		i.setAction("org.ucb.collect.android.FormSaved");
